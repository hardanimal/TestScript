...
LOCK_REG = 0x40
reg_dict = {0x03:"CAPMEAS", 0x04:"RESET_SYS", 0x05:"RESET_MIN_MAX", 0x10:"ES_CHARGE_TIMEOUT0", 0x11:"ES_CHARGE_TIMEOUT1", 0x12:"MIN_OPERATING_TEMP", 0x13:"MAX_OPERATING_TEMP", 0x14:"ES_ATTRIBUTES", 0x15:"ES_TECH", 0x16:"ES_LIFTIME", 0x20:"HWREADY", 0x21:"GTG", 0x22:"GTG_WARN", 0x23:"PGEMSTAT", 0x24:"ES_TEMP0", 0x25:"ES_TEMP1", 0x26:"VIN", 0x27:"VCAP", 0x28:"CHG-TIME", 0x29:"POR_V", 0x2A:"TCHG_V"}
...
def find_analyze_file():
    global file_string
    (ret, img_file) = file_selection("analyze files", ".dump", ".//")
...
def get_temp_his():
    ...
    print "Temperature total: ", total, "hours"
    print "--------"
...
def get_cap_his():
    ...
    print "Capacitance total: ", total, "days"
    print "--------"
...
def allreg():
    ...
    for i in reg_dict:
        ...
        print "Register 0x%x (%s) value is 0x%x " % (i, reg_dict[i], rdata)
        aa_sleep_ms(20)
    print "#############Read all registers##################"
